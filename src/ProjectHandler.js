    ...
    constructor(){
        ...
        PubSub.subscribe("populate_projects", (tag, projectsArray) => {
            ...
            projectsArray.forEach(project => {
                ProjectHandler.addNewProject(new Project(project.projectTitle, project.todos));
            });

            PubSub.publish('projects_populated', ProjectHandler.getProject("Default"));
        });
    }
}
...
class ProjectHandler{
    ...
    static getProject(title){
        const foundProject = this.#projects.find(project => project.projectTitle === title);
        return foundProject;
    }
...
class Project{
    ...
    get projectTitle(){return this.#projectTitle}
    set projectTitle(newTitle){this.#projectTitle = newTitle}

    get todos(){return this.#todos}
    set todos(newTodos){this.#todos = newTodos}
